...
alter table if exists hierarchy_levels owner to dma_user;
...
alter table if exists character_resources owner to dma_user;
alter table if exists npcs owner to dma_user;
alter table if exists bestiary_entries owner to dma_user;
alter table if exists bestiary_appearances owner to dma_user;
alter table if exists locations owner to dma_user;
alter table if exists items owner to dma_user;
alter table if exists item_appearances owner to dma_user;
alter table if exists handouts owner to dma_user;
alter table if exists encounters owner to dma_user;
alter table if exists encounter_events owner to dma_user;
alter table if exists event_narratives owner to dma_user;
alter table if exists scene_assets owner to dma_user;
alter table if exists module_publication_specs owner to dma_user;
...
alter sequence if exists character_resources_id_seq owner to dma_user;
alter sequence if exists npcs_id_seq owner to dma_user;
alter sequence if exists bestiary_entries_id_seq owner to dma_user;
alter sequence if exists bestiary_appearances_id_seq owner to dma_user;
alter sequence if exists locations_id_seq owner to dma_user;
alter sequence if exists items_id_seq owner to dma_user;
alter sequence if exists item_appearances_id_seq owner to dma_user;
alter sequence if exists handouts_id_seq owner to dma_user;
alter sequence if exists encounters_id_seq owner to dma_user;
alter sequence if exists encounter_events_id_seq owner to dma_user;
alter sequence if exists event_narratives_id_seq owner to dma_user;
alter sequence if exists scene_assets_id_seq owner to dma_user;
alter sequence if exists module_publication_specs_id_seq owner to dma_user;
